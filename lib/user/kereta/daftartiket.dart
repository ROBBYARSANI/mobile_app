...
String _getSingkatan(String kota) {
  final Map<String, String> singkatanKota = {
    'Surabaya, Pasar Turi': 'SBY-PT',
    'Surabaya, Gubeng': 'SBY-GB',
    'Semarang, Semarang Poncol': 'SMG-PC',
    'Semarang, Semarang Tawang': 'SMG-TW',
    'Yogyakarta, Lempuyangan': 'YOG-LP',
    'Yogyakarta, Tugu': 'YOG-TG',
    'Bandung, Bandung': 'BDG-BDG',
    'Bandung, Kiaracondong': 'BDG-KC',
    'Jakarta, Gambir': 'JKT-GB',
    'Jakarta, Pasar Senen': 'JKT-PS',
    'Malang, Malang': 'MLG-MLG',
    'Malang, Malang Kota Lama': 'MLG-KL',
    'Solo, Solo Balapan': 'SLO-BP',
    'Solo, Purwosari': 'SLO-PS',
    'Cirebon, Cirebon Kejaksan': 'CRB-KJ',
    'Cirebon, Cirebon Prujakan': 'CRB-PJ',
    'Surabaya, Wonokromo': 'SBY-WK',
    'Surabaya, Kandangan': 'SBY-KD',
    'Semarang, Brumbung': 'SMG-BR',
    'Semarang, Jerakah': 'SMG-JR',
    'Yogyakarta, Sentolo': 'YOG-ST',
    'Yogyakarta, Maguwo': 'YOG-MG',
    'Bandung, Padalarang': 'BDG-PD',
    'Bandung, Cimahi': 'BDG-CM',
    'Jakarta, Juanda': 'JKT-JD',
    'Jakarta, Tanah Abang': 'JKT-TA',
    'Malang, Kepanjen': 'MLG-KP',
    'Malang, Singosari': 'MLG-SG',
    'Solo, Jebres': 'SLO-JB',
    'Solo, Palur': 'SLO-PL',
    'Cirebon, Arjawinangun': 'CRB-AJ',
    'Cirebon, Babakan': 'CRB-BB',
    'Sidoarjo, Sidoarjo': 'SDO-SDO',
    'Sidoarjo, Tanggulangin': 'SDO-TG',
    'Pasuruan, Pasuruan': 'PSR-PSR',
    'Pasuruan, Bangil': 'PSR-BG',
    'Banyuwangi, Banyuwangi Baru': 'BYW-BB',
    'Banyuwangi, Ketapang': 'BYW-KT',
    'Probolinggo, Probolinggo': 'PBL-PBL',
    'Probolinggo, Leces': 'PBL-LC',
    'Madiun, Madiun': 'MDN-MDN',
    'Madiun, Caruban': 'MDN-CR',
    'Kediri, Kediri': 'KDR-KDR',
    'Kediri, Pare': 'KDR-PR',
    'Tulungagung, Tulungagung': 'TUL-TUL',
    'Tulungagung, Campurdarat': 'TUL-CD',
    'Blitar, Blitar': 'BLT-BLT',
    'Blitar, Garum': 'BLT-GR',
    'Jember, Jember': 'JMB-JMB',
    'Jember, Rambipuji': 'JMB-RB',
    'Garut, Garut': 'GRR-GRR',
    'Garut, Limbangan': 'GRR-LB',
    'Bogor, Bogor': 'BGR-BGR',
    'Bogor, Cilebut': 'BGR-CB',
    'Bekasi, Bekasi': 'BKS-BKS',
    'Bekasi, Cikarang': 'BKS-CK',
    'Depok, Depok Baru': 'DPK-DB',
    'Depok, Citayam': 'DPK-CY',
    'Tangerang, Tangerang': 'TGR-TGR',
    'Tangerang, Batuceper': 'TGR-BC',
    'Medan, Medan': 'MDN-MDN',
    'Medan, Amplas': 'MDN-AP',
    'Palembang, Kertapati': 'PLG-KP',
    'Palembang, Simpang': 'PLG-SP',
    'Lampung, Tanjung Karang': 'LPG-TK',
    'Lampung, Kedaton': 'LPG-KD',
  };
