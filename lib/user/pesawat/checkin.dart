...
class _PilihKursiViewState extends State<PilihKursiView> {
  // Anda bisa mengatur nama lokomotif dan kelas di sini
  final String namaLokomotif = "Lokomotif A";
  final String namaKelas = "Eksekutif";
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Column(
            children: [
              // Upbar dengan nama lokomotif dan kelas
              Container(
              ...
              Expanded(
                child: Container(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: 20, // Ganti sesuai jumlah kursi yang tersedia
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          // Logika pemilihan kursi
                        },
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.green, // Warna kursi default
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Center(
                            child: Text(
                              "A${index + 1}", // Contoh nomor kursi
